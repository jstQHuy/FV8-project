...
INDIR="celery_workers/vv8_worker/vv8_crawler/ALL_EXTENSIONS_D2" # this is for benign samples (from the wild) -> 528
...
do
    ...
    tmux new-session -d -s $session_name "python3 crawler_queue.py -i $INDIR -s $first -e $last"
